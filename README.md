...
- [Annabelle Calvin](mail.to:acalvin@conncoll.edu) 
...
- 🔐 **Devise** for user accounts (sign up, login via email or autogenerated username, password resets, account deletion)
- ✨ Users can log in seamlessly with either email or username (autogenerated at sign-up, e.g., `j.doe_12345`)
